    ...
    module Gouge3D
        class Gouge
            def addToModel(model, parameters)
                ...
                p = parameters.fluteWidth**2 / 16 / h
                ...
                entities.add_curve(cutoutPoints)
                ...
                profileCenterPoint = Geom::Point3d.new(GougeLength - lengthQ, 3, (r - parameters.thicknessBottom + lengthT) * -1.0)
